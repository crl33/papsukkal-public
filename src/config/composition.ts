...
export const blueSprigs: Placement[] = [
  ...
  { id: "blue-4", species: "blueMicro", screen: [0.21, 0.84], depth: 0.95, sizeFrac: 0.075, focusRole: "support", seed: 133 },
  { id: "blue-5", species: "blueMicro", screen: [0.30, 0.90], depth: 0.9, sizeFrac: 0.07, focusRole: "support", seed: 134 },
  { id: "blue-6", species: "blueMicro", screen: [0.05, 0.78], depth: 0.85, sizeFrac: 0.08, focusRole: "support", seed: 135 },
...
export const foreground: Placement[] = [
  { id: "fg-red-left", species: "softBokeh", screen: [0.23, 0.56], depth: 0.42, sizeFrac: 0.135, focusRole: "foreground", tint: "#a3141f", seed: 140 },
  { id: "fg-red-bl", species: "softBokeh", screen: [0.10, 0.83], depth: 0.34, sizeFrac: 0.155, focusRole: "foreground", tint: "#b31220", seed: 141 },
  { id: "fg-crimson-c", species: "softBokeh", screen: [0.58, 0.79], depth: 0.30, sizeFrac: 0.175, focusRole: "foreground", tint: "#a01523", seed: 142 },
